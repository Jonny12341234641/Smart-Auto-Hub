...
/**
 * LoginPage Component
 * * A split-screen login page with a branding section on the left 
 * and a floating form on the right.
 * * Features:
 * - NextAuth credential & social login
 * - Responsive design (collapses to single column on mobile)
 * - Materialistic "Pop-up" card design
 */
