                ...
                <div className="w-full max-w-md bg-card text-card-foreground shadow-2xl rounded-2xl border border-border p-8 z-10 relative ring-1 ring-inset ring-gray-200">
                    ...
                    <form className="space-y-4" onSubmit={handleRegister}>
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 w-full shadow-md hover:shadow-lg transform hover:-translate-y-0.5 duration-200"
                        >
                            {loading ? (
...
function BrandingSection() {
    return (
        <div className="hidden lg:flex w-1/2 relative flex-col items-center justify-center p-12 overflow-hidden bg-primary text-primary-foreground">
