...
// Icons (Lucide React)
import { 
  Calendar, CalendarIcon, Clock, MapPin, Car, User, Mail, Phone, 
  Edit, Trash2, CheckCircle, XCircle, Star, MessageSquare, 
...
const appointmentHistory = [
  { id: 1, type: "Vehicle Viewing", date: "November 10, 2025", status: "Completed", vehicle: "2021 Toyota Prius", rating: 5, branch: "Nugegoda" },
  { id: 2, type: "Technical Consultation", date: "October 25, 2025", status: "Completed", vehicle: null, rating: 4, branch: "Colombo" },
  { id: 3, type: "Test Drive", date: "October 15, 2025", status: "Completed", vehicle: "2022 Suzuki Swift", rating: 5, branch: "Matara" },
];

const userReviews = [
  { id: 1, vehicle: "2021 Toyota Prius", rating: 5, comment: "Excellent service and very professional staff. Highly recommended!", date: "November 11, 2025" },
  { id: 2, vehicle: "General Consultation", rating: 4, comment: "Very helpful consultation regarding financing options.", date: "October 26, 2025" },
];
 ...
 * ----------------------------------------------------------------------------
 * The main user dashboard for logged-in customers.
 * * * Architecture:
 * - Layout: Header -> Grid (Sidebar + Main Content) -> Footer.
 * - Navigation: Uses local state (`activeTab`) to switch views without page reload.
 * - Views: Appointments, Reviews, Profile, Settings.
 */
...
// ============================================================================
// SUB-COMPONENTS
// Extracted for better readability and maintenance.
// ============================================================================
...
/**
 * View 1: Appointments
 * Displays Upcoming Appointments list and Appointment History table.
 */
...
/**
 * View 3: Profile
 * Displays user details with an "Edit Mode" toggle.
 */
function ProfileView() {
  // State to toggle between view-only and edit mode
...
/**
 * View 4: Settings
 * General account settings and danger zone.
 */
